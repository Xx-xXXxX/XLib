...
{
	public interface IModNPCBehaviorComponent<TModNPC> where TModNPC : ModNPC
	{
		TModNPC ModNPC { get; }
		NPC NPC { get; }
	...
	public abstract class ModNPCBehaviorComponentOut<TModNPC> : BehaviorComponentOut<IModNPCBehavior>, IModNPCBehavior, IModNPCBehaviorComponent<TModNPC> where TModNPC : ModNPC
	{
		public NPC NPC => ModNPC.NPC;
		public TModNPC ModNPC { get; }
		public ModNPCBehaviorComponentOut(TModNPC modNPC)
		{
			ModNPC = modNPC;
		}
		#region ModNPCHook
	...
	public class ModNPCBehaviorComponent<TModNPC> : ModNPCBehaviorComponentOut<TModNPC>, IBehaviorComponent<IModNPCBehavior>
		where TModNPC : ModNPC
	{
		public ModNPCBehaviorComponent(TModNPC modNPC):base(modNPC)
		{
		}
		/// <summary>
		/// 是否同步自己
		...
		/// 装有Behavior的容器
		/// </summary>
		protected IList<IModNPCBehavior> behaviorsList = new List<IModNPCBehavior>();
		public override IReadOnlyList<IModNPCBehavior> BehaviorsList => (IReadOnlyList<IModNPCBehavior>)behaviorsList;
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
		public virtual int Add(IModNPCBehavior behavior)
		{
		...
		protected virtual void ActivateBehaviorToUsing(int id)
		{
			Usings.Add(id);
		}
		protected virtual void PauseBehaviorToUsing(int id)
		{
			Usings.Remove(id);
		}
		...
		{
			IModNPCBehavior behavior = BehaviorsList[id];
