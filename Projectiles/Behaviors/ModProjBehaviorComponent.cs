...
using System.IO;
using XLib.NPCs.Behaviors;

namespace XLib.Projectiles.Behaviors
{
	public abstract class ModProjBehaviorComponentOut<TModProj> : BehaviorComponentOut<IModProjBehavior>, IModProjBehavior
		where TModProj : ModProjectile
	{
		protected ModProjBehaviorComponentOut(TModProj modProj)
		{
			ModProj = modProj;
		}
	...
	public class ModProjBehaviorComponent<TModProj> : ModProjBehaviorComponentOut<TModProj>, IBehaviorComponent<IModProjBehavior>
		where TModProj : ModProjectile
	{
		protected ModProjBehaviorComponent(TModProj modProj):base(modProj)
		{
		}
		...
		/// 装有Behavior的容器
		/// </summary>
		protected IList<IModProjBehavior> behaviorsList = new List<IModProjBehavior>();
		public override IReadOnlyList<IModProjBehavior> BehaviorsList => (IReadOnlyList<IModProjBehavior>)behaviorsList;
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
		public virtual int Add(IModProjBehavior behavior)
		{
		...
		{
			IModProjBehavior behavior = BehaviorsList[id];
